...
<div class="card-body" style="background-image: url(img/back5.png);">
            <hr><h4 class="text-center my-3"><span style="color:pink;">DONATION RELATED </span><span style="color:red;"> NEWS</span></h4><hr>
...
<div class="row no-gutters">
    <div class="col-md-4">
        <img src="img/'.$row['img'].'" class="card-img" alt="..." width="390" height="390">
    </div>
    <div class="col-md-8">
        <div class="card-body">
